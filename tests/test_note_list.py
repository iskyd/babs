...
def test_eq():
    ...
    assert \
        Mock(Note(name='G'), Note(name='C'), Note(name='E')) == \
        Mock(Note(name='C'), Note(name='E'), Note(name='G'))

    assert not \
        Mock(Note(name='G'), Note(name='C'), Note(name='E'), Note(name='C', octave=5)) == \
        Mock(Note(name='C'), Note(name='E'), Note(name='G'))
...
def test_neq():
    ...
    assert not \
        Mock(Note(name='G'), Note(name='E'), Note(name='C')) != \
        Mock(Note(name='C'), Note(name='E'), Note(name='G'))
...
def test_repr():
    ...
    m = eval(repr(Mock(Note(name='A'), Note(name='Bb'), Note(name='C'))))
    assert m == Mock(Note(name='A'), Note(name='Bb'), Note(name='C'))